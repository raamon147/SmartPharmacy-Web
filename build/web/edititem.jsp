    ...
    <body><br/>
        ...
        <div style="margin: 40px;padding: 10px; background-color: #f8f9fa;border-radius: 10px;">
            ...
            <form method="POST" action="altGen.jsp">
                ...
                <button type="submit" class="btn btn-primary" name="alt" id="btnAlt" onclick={
                        document.getElementById("func").value = "alterar"}>Alterar</button>
                <button type="submit" class="btn btn-primary" name="exc" id="btnExc" onclick={
                        document.getElementById("func").value = "excluir"}>Excluir</button>
            </form>
            <%} else {%>
            <form method="POST" action="altFun.jsp">
                ...
                <button type="submit" class="btn btn-primary" name="alt" id="btnAlt" onclick={
                        document.getElementById("func2").value = "alterar"}>Alterar</button>
            </form>
            <%}%>
        </div>
